var Msg = {
    errorWindow: "<div id='errorWindow'> <div id='title'> <img width='14'   height='14' src='../../script/img/close.png' alt='' /> 错误</div> <div><div id='errormsg'></div><div><div style='float: right; margin-top: 15px;'><input type='button' id='ok' value='确定' style='margin-right: 10px' /></div></div></div></div>",
    ...
    a.extend(a.jqx._jqxTree.prototype, {
        ...
        refresh: function (c) {
            ...
            if (this.panel) {
                if (this.width != null && this.width.toString().indexOf("%") != -1) {
                    ...
                    b.addHandler(a(window), "resize.jqxtree" + b.element.id,
                    function () {
                        b._calculateWidth()
                    })
                } else {
        ...
        _collapseItem: function (g, k, d, b) {
            ...
            var j = function () {
                ...
                e.slideUp(g.animationHideDuration,
                function () {
        ...
        _initialize: function (f, c) {
            ...
            function () {
                ...
                if (!h) {
                    e.addHandler(k, "mouseenter",
                    function () {
                        e._arrowStyle(k, "hover", m.isExpanded)
                    });
                    e.addHandler(k, "mouseleave",
                    function () {
                        e._arrowStyle(k, "", m.isExpanded)
                    })
                }
        ...
        _updateItemEvents: function (h, k) {
            ...
            h.addHandler(a(k.checkBoxElement), e,
            function (l) {
                if (!h.disabled) {
            ...
            h.addHandler(c, "selectstart",
            function (l) {
                return false
            });
            if (a.jqx.browser.opera) {
                h.addHandler(c, "mousedown.item",
                function (l) {
                    return false
                })
            }
            if (h.toggleMode != "click") {
                h.addHandler(c, "click",
                function (l) {
