...
(function (a) {
    ...
    a.extend(a.jqx._jqxTabs.prototype, {
        ...
        _addSelectHandler: function (c) {
            var b = this;
            this.addHandler(this._titleList[c], "selectstart",
            function (d) {
                return false
            });
            this.addHandler(this._titleList[c], this.toggleMode,
            function (d) {
                return function () {
                    b._raiseEvent("15", {
                        item: d
        ...
        _addDragDropHandlers: function (c) {
            var b = this;
            this.addHandler(this._titleList[c], "mousedown",
            function (d) {
                b._captureElement(d, c);
                return false
            });
            this.addHandler(this._titleList[c], "mouseup",
            function (d) {
                if (b._tabCaptured && b._dragStarted) {
                    b._cancelClick = true;
                    b._uncapture(d, c)
        ...
        _calculateTitlesSize: function () {
            ...
            /* 卢永列 将高度 g 改成具体值27，同时和去除掉高度100%设置 解决多页签在ie下 页签标题高度的问题   */
            return {
                height: 27,
                width: 10 + d
            }
        ...
        _verticalAlignElements: function () {
            ...
            while (k) {
                ...
                /* 卢永列 移除掉，和计算高度的方法同时去掉，解决多页签在ie下 页签标题高度的问题             this._titleList[k].children(0).height("100%");*/
